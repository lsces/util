...
//echo '4<br>';
		...
		$ThisFileInfo["video"]["resolution_x"]       = (int) (round($ThisFileInfo["swf"]["header"]["frame_width"]  / 20));
		$ThisFileInfo["video"]["resolution_y"]       = (int) (round($ThisFileInfo["swf"]["header"]["frame_height"] / 20));
