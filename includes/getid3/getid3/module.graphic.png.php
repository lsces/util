...
class getid3_png
{
	...
	function PNGsRGBintentLookup($sRGB) {
		...
		return ($PNGsRGBintentLookup[$sRGB] ?? "invalid");
	}
	...
	function PNGcompressionMethodLookup($compressionmethod) {
		...
		return ($PNGcompressionMethodLookup[$compressionmethod] ?? "invalid");
	}
	...
	function PNGpHYsUnitLookup($unitid) {
		...
		return ($PNGpHYsUnitLookup[$unitid] ?? "invalid");
	}
	...
	function PNGoFFsUnitLookup($unitid) {
		...
		return ($PNGoFFsUnitLookup[$unitid] ?? "invalid");
	}
	...
	function PNGpCALequationTypeLookup($equationtype) {
		...
		return ($PNGpCALequationTypeLookup[$equationtype] ?? "invalid");
	}
	...
	function PNGsCALUnitLookup($unitid) {
		...
		return ($PNGsCALUnitLookup[$unitid] ?? "invalid");
	}
