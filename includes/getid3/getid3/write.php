...
class getid3_writetags
{
	...
	var $tagformats         = [];        // array of tag formats to write ('id3v1', 'id3v2.2', 'id2v2.3', 'id3v2.4', 'ape', 'vorbiscomment', 'metaflac', 'real')
	var $tag_data           = [[]]; // 2-dimensional array of tag data (ex: $data['ARTIST'][0] = 'Elvis')
	...
	var $warnings           = [];        // any non-critical errors will be stored here
	var $errors             = [];        // any critical errors will be stored here
